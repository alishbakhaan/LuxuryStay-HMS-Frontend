        ...
        <div className="fixed inset-0 z-40 flex">
          ...
          >
            ...
            <div className="space-y-8 border-t border-gray-200 px-4 py-6">
              ...
              <div className="flow-root">
                <a href="#" onClick={handleSignupOpen} className="group w-[50%] -m-2 flex items-center gap-2 px-2 py-1 text-sm font-bold text-gray-800 border border-gray-100 bg-gray-100 rounded-lg shadow-inner opacity-100 transform-none hover:bg-gray-200">
                  Create Account
                </a>
            ...
            <div className="flex h-16 items-center">
                  ...
                  {navigation.categories.map((category) => (
                    <Popover key={category.name} className="flex">
                      <div className="relative flex">
                        <PopoverButton className="relative z-10 -mb-px flex items-center pt-px text-sm font-medium text-white transition-colors duration-200 ease-out hover:text-gray-500">
                          {category.name}
                        </PopoverButton>
                      </div>
                      ...
                      <PopoverPanel
                        transition
                        className="absolute inset-x-0 z-[100] top-full text-sm text-white transition data-[closed]:opacity-0 data-[enter]:duration-200 data-[leave]:duration-150 data-[enter]:ease-out data-[leave]:ease-in"
                      >
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  <a href="#" onClick={handleSignupOpen} className="group -m-2 flex items-center gap-2 px-2 py-1 text-sm font-bold text-gray-800 border border-gray-100 bg-gray-100 rounded-lg shadow-inner opacity-100 transform-none hover:bg-gray-200">
                    Create Account
                  </a>
                  {signupopen && ( // Conditionally render the modal
                    <SignUp isOpen={signupopen} onClose={handleSignupClose} />
